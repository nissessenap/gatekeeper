...
require (
	...
	github.com/open-policy-agent/frameworks/constraint v0.0.0-20260128205711-a9aa88503224
...
replace github.com/open-policy-agent/frameworks/constraint => github.com/NissesSenap/frameworks-opa/constraint v0.0.0-20260209135652-df5700e8e51d
